...
export default function TemplateTaskRow({
	...
	return (
		// biome-ignore lint/a11y/noStaticElementInteractions: row opens edit sheet
		<div
			onClick={onClick}
			onKeyDown={(e) => {
			...
			tabIndex={0}
			className={cn(
				"group relative flex items-center gap-3 px-4 py-1.5 transition-colors cursor-pointer border-b border-border/50 hover:bg-accent/60",
			)}
		>
			{showPriority && (
